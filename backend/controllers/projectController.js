...
// @desc    Get progress levels

// @route   GET /api/v1/projects/progress-levels

// @access  Private

exports.getProgressLevels = async (req, res, next) => {
...
exports.updateProjectProgress = async (req, res, next) => {
  ...
  try {
    ...
    console.log('=== UPDATE PROJECT PROGRESS DEBUG ===');
    ...
    if (!progressLevels[progressLevel]) {
      ...
      console.log('Invalid progress level:', progressLevel);

      console.log('Available progress levels:', Object.keys(progressLevels));
    ...
    if (!project.allocatedTo) {
      ...
      console.log('Project not allocated to any freelancer');
    ...
    if (project.allocatedTo.toString() !== req.user.id) {
      ...
      console.log('Project not allocated to this freelancer');
